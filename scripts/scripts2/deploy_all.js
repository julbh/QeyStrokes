...
async function main(network) {
    ...
    await marketplace.initialize(TREASURY_ADDRESS, PLATFORM_FEE, REWARD_TOKEN_ADDR, TREASURY_ADDRESS, FANTOM_ADDRESS_REGISTRY);
    ...
    await bundleMarketplace.initialize(TREASURY_ADDRESS, PLATFORM_FEE, REWARD_TOKEN_ADDR, TREASURY_ADDRESS, FANTOM_ADDRESS_REGISTRY);
    ...
    await auction.initialize(TREASURY_ADDRESS, REWARD_TOKEN_ADDR, TREASURY_ADDRESS, FANTOM_ADDRESS_REGISTRY);
